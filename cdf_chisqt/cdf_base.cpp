...
double cdf_t(double x, double df, int lower_tail){
    return pt(x, df, lower_tail, false);
}

//cdf of t, with log p
double cdf_t_log(double x, double df, int lower_tail){
    return pt(x, df, lower_tail, true);
}
...
double quantile_t(double p, double df, int lower_tail){
    return qt(p, df, lower_tail, false);
}

double quantile_chisq(double p, double df, int lower_tail){
    return qchisq(p, df, lower_tail, false);
}
